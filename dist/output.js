...
Output.define = function (name, subcode, msg) {
    var NewOutput = util.clone.call(Output, name);
    var code = toText(name);
...
Output.prototype.clone = function (v) {
    var output = new this.constructor(this.code, this.subcode, this.msg);
